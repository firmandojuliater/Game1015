...
$result = array();
$query = "SELECT * from tb_laporan WHERE created_by='$username' AND periode IN (SELECT max(id_periode) from tb_periode where username='$username') ORDER BY id_laporan";
