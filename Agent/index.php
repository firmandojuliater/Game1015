      								...
      								<div id="side_accordion" class="accordion">
      										...
      										<div class="accordion-body collapse" id="collapseOne">
      											<div class="accordion-inner">
      												<ul class="nav nav-list">
      													<li><a href="?page=add_user">Add Member</a></li>
      													<li><a href="?page=list_user">List Member</a></li>
      												</ul>
      											</div>
      										</div>
      									</div>
      									<div class="accordion-group">
      										...
      										<div class="accordion-body collapse" id="collapseTwo">
      											<div class="accordion-inner">
      												<ul class="nav nav-list">
      													<li><a href="?page=bet">Bet Member</a></li>
      													<li><a href="?page=credit">Credit Member</a></li>
      													<li><a href="?page=diskon_hadiah">Diskon & Hadiah Member</a></li>
      												</ul>
      											</div>
      										</div>
      									</div>
